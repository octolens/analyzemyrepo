...
const GeoChartContributorsShare: NextPage<MyProps> = (props: MyProps) => {
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="og:image"
          content={`${host}/api/og_geochartcontributors?org_name=${org_name}&repo_name=${repo_name}`}
        />
...
export default GeoChartContributorsShare;
